...
/**
 * Experimental reversible pairing functions, which could be useful for hashing. 
 */
public class HashUtils {
	...
	/**
	 * <p>
	 * These functions are useful for anyone wanting to set up
	 * enumeration or give a single number for every
	 ...
	 * infinitely growing parameters. You can think of it as a way of growing
	 ...
	 * 
	 * To decombine a number into a set of other numbers, the number of
